...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='realestatehub'),
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 12,  # Match frontend page size for infinite scroll
...
cloudinary.config(
    cloud_name=config('CLOUDINARY_CLOUD_NAME', default='drfdulfxd'),
    api_key=config('CLOUDINARY_API_KEY', default='461178186378124'),
    api_secret=config('CLOUDINARY_API_SECRET', default='rMpXNBBFVBAInt5HdS9ybprb8hE'),
    secure=True
)